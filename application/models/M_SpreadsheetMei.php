...
class M_SpreadsheetMei extends CI_Model
{
    public function index()
    {
        $response = [];

        $json_string = 'https://script.google.com/macros/s/AKfycbyUyAAQUOYL6C23M9cgKUTm522fouqAf9UFFsElvBopA96wXKm-6IWc6ywLS78XbuSG/exec';
